...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "AIRS Predictive Intelligence Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Inter-Agency Predictive Forensic Unit (VA / CalVets Continuity Taskforce)";
process.env.TABLE_NAME = process.env.TABLE_NAME || "inter_agency_predictive_forensic_unit__va___calvets_continuity_taskforce__records";
'use strict';
